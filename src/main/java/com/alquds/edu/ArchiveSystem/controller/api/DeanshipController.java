...
import com.alquds.edu.ArchiveSystem.dto.academic.RequiredDocumentTypeDTO;
...
import com.alquds.edu.ArchiveSystem.dto.dashboard.RecentActivity;
import com.alquds.edu.ArchiveSystem.dto.dashboard.StatusDistribution;
...
public class DeanshipController {
    ...
    private final com.alquds.edu.ArchiveSystem.repository.academic.DepartmentRepository departmentRepository;
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'DEANSHIP')")
    public ResponseEntity<ApiResponse<List<com.alquds.edu.ArchiveSystem.entity.academic.Semester>>> getSemestersByAcademicYear(@PathVariable Long id) {
        log.info("Deanship retrieving semesters for academic year: {}", id);
        
        try {
            List<com.alquds.edu.ArchiveSystem.entity.academic.Semester> semesters = academicService.getSemestersByYear(id);
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'DEANSHIP')")
    public ResponseEntity<ApiResponse<com.alquds.edu.ArchiveSystem.entity.file.Folder>> createProfessorFolder(
            @PathVariable Long id,
        ...
        try {
            com.alquds.edu.ArchiveSystem.entity.file.Folder folder = professorService.createProfessorFolder(
                    id, academicYearId, semesterId);
            return ResponseEntity.status(HttpStatus.CREATED)
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'DEANSHIP')")
    public ResponseEntity<ApiResponse<List<com.alquds.edu.ArchiveSystem.entity.file.Folder>>> createCourseFolders(
            @PathVariable Long id) {
        
        log.info("Deanship creating course folders for assignment ID: {}", id);
        
        try {
            List<com.alquds.edu.ArchiveSystem.entity.file.Folder> folders = courseService.createCourseFoldersForAssignment(id);
            return ResponseEntity.status(HttpStatus.CREATED)
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'DEANSHIP')")
    public ResponseEntity<ApiResponse<List<com.alquds.edu.ArchiveSystem.entity.academic.Department>>> getAllDepartments() {
        log.info("Deanship retrieving all departments");
        
        try {
            List<com.alquds.edu.ArchiveSystem.entity.academic.Department> departments = departmentRepository.findAll();
