...
public interface EmailValidationService {
     ...
     * @throws com.alquds.edu.ArchiveSystem.exception.ValidationException if email doesn't end with @admin.alquds.edu
     */
     ...
     * 
     * @param email The email to validate
     * @throws com.alquds.edu.ArchiveSystem.exception.ValidationException if email doesn't end with @dean.alquds.edu
     */
     ...
     * 
     * @param email The email to validate
     * @throws com.alquds.edu.ArchiveSystem.exception.ValidationException if email doesn't end with @staff.alquds.edu
     */
     ...
     * 
     * @param email The email to validate
     * @throws com.alquds.edu.ArchiveSystem.exception.ValidationException if email doesn't match pattern or shortcut doesn't exist
     */
