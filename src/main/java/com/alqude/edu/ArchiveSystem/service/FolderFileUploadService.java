...
public interface FolderFileUploadService {
     ...
     * @throws com.alqude.edu.ArchiveSystem.exception.FolderNotFoundException if folder doesn't exist
     * @throws com.alqude.edu.ArchiveSystem.exception.UnauthorizedException if user doesn't have permission
     * @throws com.alqude.edu.ArchiveSystem.exception.FileValidationException if files fail validation
     * @throws com.alqude.edu.ArchiveSystem.exception.FileStorageException if file storage fails
     ...
     * @throws com.alqude.edu.ArchiveSystem.exception.FileValidationException if validation fails with specific error message
     */
     ...
     * 
     * Examples:
     * - "lecture notes.pdf" → "lecture_notes.pdf"
     * - "file@#$.doc" → "file___.doc"
     * - "report.pdf" (if exists) → "report(1).pdf"
     * - "report(1).pdf" (if exists) → "report(2).pdf"
     * 
