...
public class HodController {
    ...
    private final com.alquds.edu.ArchiveSystem.service.academic.AcademicService academicService;
    ...
    public ResponseEntity<ApiResponse<List<com.alquds.edu.ArchiveSystem.entity.academic.AcademicYear>>> getAllAcademicYears() {
        ...
        try {
            List<com.alquds.edu.ArchiveSystem.entity.academic.AcademicYear> academicYears = academicService.getAllAcademicYears();
