...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleDisabledException(
        ...
        String requestId = generateRequestId();
        log.warn("Disabled account login attempt [{}]: {}", requestId, ex.getMessage());
        
        ErrorResponse errorResponse = ErrorResponse.of("ACCOUNT_DISABLED", "Your account has been deactivated")
                .withPath(getRequestPath(request))
                .withStatus(HttpStatus.FORBIDDEN.value())
    ...
    public ResponseEntity<ApiResponse<Object>> handleLockedException(
        ...
        String requestId = generateRequestId();
        log.warn("Locked account login attempt [{}]: {}", requestId, ex.getMessage());
        
        ErrorResponse errorResponse = ErrorResponse.of("ACCOUNT_LOCKED", "Your account has been locked")
                .withPath(getRequestPath(request))
                .withStatus(HttpStatus.FORBIDDEN.value())
