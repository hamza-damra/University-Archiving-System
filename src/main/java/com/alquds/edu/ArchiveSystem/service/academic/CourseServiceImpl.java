...
public class CourseServiceImpl implements CourseService {
    ...
    public CourseAssignment assignCourse(CourseAssignmentDTO dto) {
        ...
        try {
            ...
            try {
                ...
                log.error(
                        "Failed to create course folder structure for assignment id: {}. Assignment creation succeeded.",
            ...
            throw new DuplicateEntityException(
                    "Course assignment already exists for this semester, course, and professor combination");
        }
    }
    ...
    public void unassignCourse(Long assignmentId) {
        ...
        // This preserves historical data and related entities (submissions, folders)
        assignment.setIsActive(false);
        courseAssignmentRepository.save(assignment);

        log.info("Course assignment soft deleted (set to inactive) successfully with id: {}", assignmentId);
    }
    ...
    public List<CourseAssignment> getAssignmentsByProfessor(Long professorId, Long semesterId) {
        ...
        List<CourseAssignment> assignments = courseAssignmentRepository.findByProfessorIdAndSemesterId(professorId,
                semesterId);
        // Eagerly fetch lazy-loaded relationships to avoid serialization issues
        assignments.forEach(assignment -> {
            if (assignment.getProfessor() != null) {
